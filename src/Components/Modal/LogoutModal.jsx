...
export default function LogoutModal({openModal, setOpenModal,message,subMessage,confirmLogout}) {
        ...
        <Modal.Body className="">
          ...
          <h3 className="mb-5 mt-5 md:mt-10 text-sm font-normal text-gray-500 dark:text-gray-400">
            ...
            <div className="flex justify-center gap-4">
              <Button className="border-2 border-[#0000006b] text-[black] rounded-full" onClick={() =>{
                 setOpenModal(false)
                 confirmLogout()
              }}>
                {"Yes, I'm sure"}
              </Button>
              <Button className="text-[white] bg-[black] border-none rounded-full items-center" onClick={() => setOpenModal(false)}>
                No, cancel
              </Button>
            </div>
          </div>
