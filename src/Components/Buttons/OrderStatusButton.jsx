...
export default function OrderStatusButton({ orderStatus }) {
  return (
    <>
      <div className={`${orderStatus=='rejected'?'border-[#fa9090]':'border-[#f7f5f5]'} flex items-center gap-1 text-sm md:text-base text-[#4e4d4d] font-bold py-3 px-2 bg-[#ffffff] shadow-lg w-fit rounded-lg border-2 mt-5`}>
