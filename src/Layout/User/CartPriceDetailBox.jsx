...
export default function CartpriceDetailBox({ cart, card, bottomDifference }) {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div>
            <div className="w-3/4 h-10 mx-auto mb-10 flex order-1">
              ...
              <div className="w-1/2 h-full">
                <h1 className="text-[black] font-bold text-end text-base md:text-lg">
                  ₹9,990
                </h1>
              </div>
            </div>
            <div className="w-3/4 h-10 mx-auto  flex order-2">
              <div className="w-1/2 h-full">
              ...
              <div className="w-1/2 h-full">
                <h1 className="text-[#33856c] font-bold text-end">- ₹9,990</h1>
              </div>
            </div>
          </div>
          <div>
            <hr className="w-[90%] mx-auto mb-5"></hr>
            <div className="w-3/4 h-10 mx-auto flex">
              <div className="w-1/2 h-full">
                <h1 className="text-[black] font-bold text-start text-lg md:text-xl">
                  Total amount
                </h1>
              </div>
              <div className="w-1/2 h-full">
                <h1 className="text-[black] font-extrabold text-end text-lg md:text-xl">
                  ₹9,990
                </h1>
              </div>
            </div>
